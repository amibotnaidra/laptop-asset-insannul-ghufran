...
with st.container():
    ...
    with left_column:
        st.write(
            ...
            - Display Name: Insannul Ghufran
            - User Principal Name: insannul.ghufran@gobel.co.id
            - Model Name: Laptop Legion Pro 5 16IRX9
            - PC Name: IIAPG-Ghufran
            - Laptop Code: IIAPG-NB24-007
            - Job Title: Building Engineer Staff
            - Department: IIAPG
            - Email: insannul.ghufran@outlook.com
